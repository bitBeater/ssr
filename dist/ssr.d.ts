 ...
 * @param e
 */
export declare type ssrSaveFn<T> = (e: T[]) => Promise<T[]>;
/**
 * perform a paginated and ordered search on entities
 * if search is not provided, all entities are returned
 * @param search
 */
export declare type ssrSearchFn<T> = (search?: PaginatedSearch<T>) => Promise<PaginatedResult<T>>;
/**
 * delete entities matching the search parameters
 * @param search
 **/
export declare type ssrRemoveFn<T> = (search: Search<T>) => Promise<T[]>;
